  ...
  static Future<Response> _handler(Request request) async {
    ...
    switch (request.method) {
      case 'GET':
        ...
        if (request.url.pathSegments.last == 'heroes') {
          data = _heroesDb;
        } else if (int.parse(request.url.pathSegments.last) != null) {
      ...
      case 'DELETE':
        var id = int.parse(request.url.pathSegments.last);
        _heroesDb.retainWhere((hero) => hero.id == id);
        break;
      default:
        throw 'Unimplimented HTTP method ${request.method}';
    }
